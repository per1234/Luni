...
The document device-driver.md describes the overall architecture of the proposed Arduino Device Driver architecture.  This Appendix C document defines the detailed message formats used to communicate between the client and Firmata and back again.
