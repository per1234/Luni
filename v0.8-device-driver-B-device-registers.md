...
##3/11/2016 11:38:58 PM The following text is incomplete!!!##
...
See Appendix A for information about the operation of the common registers.

---
###`PIN`
####Get/set the pin number controlling this servomotor.
...
---
###`SCALE`
####Set the range to use in scaling the input position to degrees.
...
---
###`POSITION`
####Get and Set the current position of the servomotor.
